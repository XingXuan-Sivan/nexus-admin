...
| 解析 | RESOLVED | 插件已解析 |
| 加载 | LOADED | 插件已加载 |
| 初始化 | INITIALIZING, INITIALIZED | 初始化开始/完成 |
| 启动 | STARTING, STARTED | 启动开始/完成 |
| 停止 | STOPPING, STOPPED | 停止开始/完成 |
| 卸载 | UNLOADING, UNLOADED | 卸载开始/完成 |
| 禁用 | DISABLING, DISABLED | 禁用开始/完成 |
| 启用 | ENABLING, ENABLED | 启用开始/完成 |
| 升级 | UPGRADING, UPGRADED | 升级开始/完成 |
| 失败 | FAILED | 任意阶段失败 |
